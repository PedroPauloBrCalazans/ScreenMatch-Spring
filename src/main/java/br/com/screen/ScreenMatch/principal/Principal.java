...
import br.com.screen.ScreenMatch.model.*;
...
public class Principal {
    ...
    private void buscarSeriePorTitulo() {
        System.out.println("Escolha uma série pelo nome: ");
        var nomeSerie = leitura.nextLine();
        Optional<Serie> serieBuscada = serieRepository.findByTituloContainingIgnoreCase(nomeSerie); //mais rápido que o stream
    ...
    private void filtrarSeriesPorTemporadaEAvaliacao(){
        ...
        var avaliacao = leitura.nextDouble();
        leitura.nextLine();
        List<Serie> filtroSeries = serieRepository.findByTotalTempLessThanEqualAndAvaliacaoGreaterThanEqual(totalTemporadas, avaliacao);
